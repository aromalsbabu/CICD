...
<head>
    ...
    <title>Aromal's DevOps Test</title>
...
<div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">Aromal's DevOps AWS Lab</a>
        </div>
...
<div class="jumbotron">
    <div class="container">
        <h1>Hello</h1>
        <p>This is Aromal`s DevOps AWS Lab</p>
...
<div class="container">
    ...
    <footer>
        <p>&copy; Aromal's devops lab 2021</p>
    </footer>
</div> <!-- /container -->
